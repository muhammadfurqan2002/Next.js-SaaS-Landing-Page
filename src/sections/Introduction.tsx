        ...
        <div className="container">
            <div className="sticky top-20">
                ...
                <div className="text-4xl md:text-6xl lg:text-7xl text-center font-medium mt-10">
                    ...
                    <span className="text-white/50">{words.map((word,i)=>(
                        <span key={i} className={twMerge("transition duration-500 text-white/50",i<currentWord && "text-white")}>{`${word} `}</span>
                    ))}</span>
