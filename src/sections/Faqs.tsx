...
export default function Faqs() {
    const [selectedIndex, setSleectedIndex] = useState<number | null>(null);
            ...
            <div className="mt-12 flex flex-col gap-6 max-w-xl mx-auto">
                {faqs.map((faq, index) => (
                    <div key={index} className="g-neutral-900 rounded-2xl border border-white/10 p-6">
                        <div onClick={() => setSleectedIndex(index === selectedIndex ? null : index)} className="flex justify-between items-center" >
                        ...
                        <AnimatePresence>
                            {selectedIndex == index && (
                                ...
                                <motion.div initial={{ height:0,marginTop: 0 }} animate={{ height: "auto",marginTop: 24 }} exit={{ height: 0,marginTop: 0 }} transition={{ duration: 0.3 }} className={twMerge("mt-6 overflow-hidden")} >
